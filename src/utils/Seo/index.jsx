...
export default function Seo(){
  const title = 'Aashutosh Soni | FullStack Developer';
  const description =
    "Hello, I'm Aashutosh Soni, a FullStack Developer and pre-Final year student, crafting high-quality web, app, and SAAS solutions with a focus on shipping values and excellence.";
  ...
  return (
    <Helmet>
      ...
      <meta property="og:image:alt" content="Aashutosh Soni" />
      ...
      <meta
        name="keywords"
        content="Aashutosh Soni, ashutosh7i, FullStack Developer, MERN Stack, Web Development, Aashutosh Soni Indore, Aashutosh Soni AITR"
      />
