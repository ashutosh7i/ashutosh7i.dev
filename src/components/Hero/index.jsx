...
// import "../../../public/assets/customFonts/font.css";
...
import { abrade, eduSABegineer } from "@/utils/fonts.js";
const FloatingText1 = ({ text }) => {
  return <div className="floating-text1">{text}</div>;
};
const FloatingText2 = ({ text }) => {
  return <div className="floating-text2">{text}</div>;
};
      ...
      <Container id="Hero" maxW="4xl" px={{ base: 6, md: 3 }} py={150}>
        <Stack direction={{ base: "column-reverse", md: "row" }}>
          <Stack direction="column" spacing={6} maxW="500px">
            <HStack
              className={eduSABegineer.className}
              p={1}
              rounded="full"
              fontSize="sm"
              w="max-content"
            ...
            >
              <HStack spacing={1} alignItems="center" justifyContent="center">
                <Text fontSize={"17px"} pl={2} lineHeight={1}>
                  💡Have an Idea?
                </Text>
              </HStack>
              <Link
